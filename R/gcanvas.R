...
##' class for gcanvas
##'
##' The gcanvas widget provides a canvas for drawing on or for
##' displaying graphics produced by the canvas device. The drawing is
##' supported through a series of low-level primitives:
##' \code{polygon}, \code{lines}, \code{rect}, \code{circle}. Others
##' are possible. These are R5 methods of the canvas object. In
